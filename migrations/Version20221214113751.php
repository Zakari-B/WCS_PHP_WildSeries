...
final class Version20221214113751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE watchlist (program_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_340388D33EB8070A (program_id), INDEX IDX_340388D3A76ED395 (user_id), PRIMARY KEY(user_id, program_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
